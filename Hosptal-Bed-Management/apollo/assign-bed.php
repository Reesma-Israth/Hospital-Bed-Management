<html>
	<head></head>
	<body style="background-color:#d2f174">
<?php
	session_start();
        ...
        <div id="containerHolder">
			<div id="container">
        		<div id="sidebar">
					...
					<a class="btn btn-secondary" href="patients.php" role="button" style="margin-left: 20px;   border:solid 5px black;">View All Patients</a>
					<a class="btn btn-secondary" href="add-patient.php" role="button" style="margin-left: 350px;  border:solid 5px black;">Add New Patients</a>
					<a class="btn btn-secondary active" href="assign-bed.php" role="button" style="margin-left: 350px;  border:solid 5px black;">Assign/Unassign beds</a>
                ...
                <h2 style="text-align:center;">Assign/Unassign Beds</h2>
                ...
                <form method="post" class="jNice" name="frm1">
					...
					?>
                    	<fieldset>
                            ...
                            <select name="patient" style="border:solid 2px black; background-color:	#a5e86e;">
                            ...
                            <p><label>Bed:</label>
                            <select name="bed" style="border:solid 2px black; background-color:	#a5e86e;">
                            	<option value="none">[--------SELECT--------]</option>
                            	<?php
                            ...
                            <input type="submit" value="Assign Bed" name="assign" style="border:solid 2px black; margin-left:100px; background-color:#81814e; color:white;""/>
                        </fieldset>
                    </form>
                        <br /><br />
					...
					?>
                    	<fieldset>
                            ...
                            <select name="ptb" style="border:solid 2px black; background-color:	#a5e86e;">
                            	<option value="none" >[--------SELECT--------]</option>
                                <?php
                            ...
                            <input type="submit" value="Unassign Bed" name="unassign" style="border:solid 2px black; margin-left:100px; background-color:#81814e; color:white;"/>
